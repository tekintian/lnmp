...
#   Author: Teddysun <i@yunnan.ws>                             #
#   Thanks: @clowwindy <https://twitter.com/clowwindy>            #
#   Intro:  https://yunnan.ws/342.html                         #
#=================================================================#
...
echo "# Intro: https://yunnan.ws/342.html                      #"
echo "# Author: Teddysun <i@yunnan.ws>                         #"
...
pre_install(){
    ...
    read -p "(Default password: yunnan.ws):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="yunnan.ws"
    echo
    echo "---------------------------"
...
install(){
    ...
    if [ -f /usr/bin/ssserver ] || [ -f /usr/local/bin/ssserver ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks install failed! please visit https://yunnan.ws/342.html and contact."
        install_cleanup
        exit 1
    fi
    ...
    echo
    echo "Welcome to visit:https://yunnan.ws/342.html"
    echo "Enjoy it!"
    echo
}
