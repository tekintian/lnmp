#!/bin/bash
# LNMP fro mulity php version supported
# Author:  TekinTian
# https://dev.yunnan.ws
#
...
#
# Project home page:
#       https://bitbucket.org/tekintian/lnmp
